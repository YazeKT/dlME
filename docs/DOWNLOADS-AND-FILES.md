...
Video jobs go to `Video`; audio-only jobs go to `Audio`. The remaining categories let the Files table classify items found in remembered download roots. dlME 0.9.1 is a media downloader and does not provide a general application or archive download engine.
