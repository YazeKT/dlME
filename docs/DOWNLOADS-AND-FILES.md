...
Video jobs go to `Video`; audio-only jobs go to `Audio`. The remaining categories let the Files table classify items found in remembered download roots. dlME 1.0.0 is a media downloader and downloads arbitrary file types through torrents; media URL jobs remain handled by yt-dlp.
